...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='Please enter your Course Code!!!', fg='red',
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            ENR = tk.Label(MFW, text="Enter ID", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Name", width=15, height=2, fg="black", bg="grey",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'C:/FRAS/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/FRAS/Attendance/Manually Attendance/-------Check atttendance-------"')
    ...
    SUB = tk.Label(sb, text="Enter Course Code : ", width=15, height=2,
    ...
    fill_manual_attendance = tk.Button(sb, text="Enter", command=fill_attendance, fg="black", bg="SkyBlue1", width=20, height=2,
                                       activebackground="white", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    Label(sc1, text='ID & Name required!!!', fg='black',
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("Training Image/ " + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray)
            ...
            with open('C:/FRAS/Student Details/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                harcascadePath = "C:/FRAS/haarcascade_frontalface_default.xml"
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/FaceR/Attendance/-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets", command=Attf, fg="white", bg="black",
                     width=12, height=1, activebackground="white", font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Enter Course Code : ", width=15, height=2,
    ...
    fill_a = tk.Button(windo, text="Enter", fg="white", command=Fillattendances, bg="SkyBlue1", width=20, height=2,
                       activebackground="white", font=('times', 15, ' bold '))
...
def admin_panel():
    ...
    def log_in():
        ...
        if username == 'BlckSnSher':
            if password == 'Sher0209':
                win.destroy()
                import csv
                import tkinter
                root = tkinter.Tk()
                ...
                cs = 'C:/FaceR/Student Details/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
    ...
    pw = tk.Label(win, text="Password : ", width=15, height=2, fg="black", bg="grey",
                  font=('times', 15, ' bold '))
    pw.place(x=30, y=150)
